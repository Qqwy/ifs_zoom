...
\section{Abstract}
\label{sec:orgd4eeed8}

\todo[inline]{Write}

\section{Introduction}
\label{sec:org8f60ae0}
...
\subsection{Overview}
\label{sec:org6dc882d}

\todo[inline]{Write Overview}

\section{Background}
\label{sec:org7f1de23}
...
\begin{enumerate}
\item Potential point cloud-based optimizations
\label{sec:org0070bb1}
...
\item Simplicity
\label{sec:org479085d}

\todo[inline]{remove this section/move to 'Implementation'?}

As mentioned in the previous subsection, the decision was made to keep the program as simple as possible. 
...
Accelerate presents errors at compile-time in many cases.}

The usage of Haskell as implementation language also allowed the easy construction of different subcomponents making up the program,
and testing each of these independently, being a pure functional language.

\subsubsection{Rendering}
\label{sec:org177fbb3}

\subsubsection{Command-line options}
\label{sec:org6197cdf}

\subsubsection{IFS file format}
\label{sec:orga0cdbc8}

\subsubsection{Rendering 'guides'}
\label{sec:org834aaaa}

\subsubsection{Manually going to a more shallow view}
\label{sec:orgcf7a295}

\section{Findings}
\label{sec:org4ae5fb8}

\subsection{Restrictions on replacing the view with a more shallow view}
\label{sec:org1d3588c}
...
\section{Discussion}
\label{sec:orged143d7}

\section{Conclusion}
\label{sec:org73c54ea}

\section{Further Work}
\label{sec:org3899552}
\end{document}