...
Dashed red lines are used for the first couple of iterations to indicate the self-similarity between the previous iteration and the current one extra clearly.
...
\label{sec:org3c3b2b3}
\todo[inline]{Write}

\subsubsection{`.ifs' file format}
\label{sec:orgb946bcb}
